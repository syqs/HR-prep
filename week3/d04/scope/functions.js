...
//
  ...
  describe('Function Exercises', function () {
      ...
      it('the rule about retaining access to variables from an outer scope still applies, even after the outer function call (that created the outer scope) has returned', function () {
        ...
        // running this outer function should have the same effect as running the whole previous test,
        ...
        // the inner function remains available in the global scope, and still has access to the variables of
        // that containing scope where it was first created.
